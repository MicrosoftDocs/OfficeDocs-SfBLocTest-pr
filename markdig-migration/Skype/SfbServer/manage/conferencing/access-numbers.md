...
12. To add a region for the dial-in access number, under **Associated regions**, click ** Add<strong>, click one or more regions that are associated with the dial plans for this dial-in access number, and then click **OK</strong>.
